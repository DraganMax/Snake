...
function () {
  ...
  Grid.prototype.seed = function () {
    for (var i = 0; i < 5; i++) {
      this.apples.push(new _Cell.Cell(Math.floor(Math.random() * _Configuration.CELLS_HORIZONTAL), Math.floor(Math.random() * _Configuration.CELLS_VERTICAL)));
    }
  };
...
exports.Grid = Grid;
},{"./Cell":"../src/engine/Cell.ts","./Configuration":"../src/engine/Configuration.ts"}],"../src/engine/Snake.ts":[function(require,module,exports) {
"use strict";
